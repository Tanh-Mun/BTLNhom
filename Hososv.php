<?php
// Dữ liệu mẫu thông tin sinh viên khớp với mục tìm và đặt lịch
$student_profile = [
    'name' => 'Lê Hoàng Nam',
    'email' => 'nam.le@sv.edu',
    'phone' => '0923456789',
    'student_id' => 'SV20265678',
    'faculty' => 'Khoa Tiếng Anh',
    'major' => 'Ngôn ngữ Anh',
    'bio' => 'Sinh viên năm 3, quan tâm đến các buổi tư vấn kỹ năng phát âm và IELTS Speaking.'
];

$selected_student = $student_profile['name'];
...
// Xác định đường dẫn quay lại trang trước (mặc định về TimVaDatLich.php nếu không có HTTP_REFERER)
$back_url = isset($_SERVER['HTTP_REFERER']) ? $_SERVER['HTTP_REFERER'] : 'TimVaDatLich.php';
?>
...
<head>
    ...
    <style>
        ...
        * { box-sizing: border-box; margin: 0; padding: 0; font-family: 'Segoe UI', Tahoma, Geneva, Verdana, sans-serif; }
        ...
        /* Avatar tĩnh ở góc trên bên phải (không có chức năng) */
        .user-profile-icon {
            display: flex;
            align-items: center;
            gap: 10px;
...
<body>
    ...
    <div class="header">
        <div class="header-brand">
            ...
            <div class="header-text">
                <h2>EDULINGO</h2>
                <p>Hệ thống đặt lịch tư vấn sinh viên</p>
            </div>
        </div>

        <!-- Avatar tĩnh mặc định, không có chức năng và không có menu thả xuống -->
    ...
    <div class="container">
        ...
        <div class="profile-header">
            ...
            <div>
                <div class="profile-title">HỒ SƠ SINH VIÊN</div>
                <div class="profile-name"><?= htmlspecialchars($student_profile['name']) ?></div>
                <div class="profile-sub">Mã SV: <?= htmlspecialchars($student_profile['student_id']) ?> · <?= htmlspecialchars($student_profile['email']) ?></div>
            </div>
        </div>
            ...
            <form method="POST">
                <div class="form-grid">
                    <div class="form-group">
                        ...
                        <input type="text" name="name" value="<?= htmlspecialchars($student_profile['name']) ?>">
                    </div>
                    <div class="form-group">
                        <label>Mã sinh viên</label>
                        <input type="text" name="student_id" value="<?= htmlspecialchars($student_profile['student_id']) ?>">
                    </div>
                    <div class="form-group">
                        <label>Email</label>
                        <input type="email" name="email" value="<?= htmlspecialchars($student_profile['email']) ?>">
                    </div>
                    <div class="form-group">
    ...
    <div class="footer">
        ...
        <div>
            ...
            <ul>
                <li>Đặt lịch tư vấn</li>
                <li>Lịch hẹn của tôi</li>
            </ul>
        </div>
        <div>
