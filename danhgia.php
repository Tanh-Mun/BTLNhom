...
<head>
    ...
    <style>
        ...
        * { box-sizing: border-box; margin: 0; padding: 0; font-family: 'Segoe UI', Tahoma, Geneva, Verdana, sans-serif; }
        ...
        .status-tag { background-color: #e2e3e5; color: #383d41; font-size: 11px; font-weight: normal; padding: 2px 8px; border-radius: 4px; }
    ...
    <div class="container">
        ...
        <div class="content-box">
            ...
            <?php if (!empty($appointments)): ?>
                ...
                <?php endforeach; ?>
            <?php else: ?>
                <p style="color: #666; font-size: 14px;">Bạn đã hoàn thành tất cả đánh giá buổi học!</p>
            <?php endif; ?>
        </div>
    </div>
