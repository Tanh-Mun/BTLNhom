...
<head>
    ...
    <style>
        ...
        * { box-sizing: border-box; margin: 0; padding: 0; font-family: 'Segoe UI', Tahoma, Geneva, Verdana, sans-serif; }
        ...
        .teacher-topic { color: var(--primary-color); font-size: 13px; margin-bottom: 4px; font-weight: 600; }
        .teacher-time { color: #666; font-size: 12px; display: flex; gap: 15px; margin-top: 4px; }
                    ...
                    <div class="teacher-card">
                        <div class="teacher-info">
                            ...
                            <div class="teacher-time">
                                <span><i class="fa-regular fa-clock"></i> <?= date('d/m/Y H:i', strtotime($row['start_time'])) ?> - <?= date('H:i', strtotime($row['end_time'])) ?></span>
                                <span><i class="fa-solid fa-location-dot" style="color: var(--primary-color);"></i> <?= htmlspecialchars($row['location'] ?? 'Trực tuyến') ?></span>
                            </div>
                        </div>
