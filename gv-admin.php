...
// Xử lý tìm kiếm qua AJAX hoặc tải lại trang tự động
...
<head>
    ...
    <style>
        ...
        * { box-sizing: border-box; margin: 0; padding: 0; font-family: Arial, sans-serif; }
        ...
        .date-nav-btn:hover { background: var(--primary-light); }
...
<body>
    ...
    <!-- Modal Xem Hồ Sơ & Lịch Giảng Viên -->
    ...
    <script>
        // Dữ liệu giảng viên phía JavaScript để lọc realtime không cần reload
        ...
        // Xử lý tìm kiếm realtime bằng sự kiện 'input'
