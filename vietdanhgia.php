...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    // Có thể lưu đánh giá vào session ở đây nếu muốn hiển thị lại
...
<head>
    ...
    <style>
        ...
        * { box-sizing: border-box; margin: 0; padding: 0; font-family: Arial, sans-serif; }
        ...
        .dropdown-item { color: #333; padding: 10px 16px; text-decoration: none; display: flex; align-items: center; gap: 8px; font-size: 13px; }
